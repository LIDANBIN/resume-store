      ...
      <view v-show="webview === 0">
        <view class="add-open">
          ...
          <button class="mini-btn" type="primary" size="middle" @click="openModule">
            <view
              class="uni-icon"
              :class="isAllModuleOpen ? 'uni-icon-arrowup' : 'uni-icon-arrowdown'"
            ></view>
          ...
          <view class="uni-list">
            <view class="uni-list-cell uni-collapse">
              ...
              <view class="uni-list uni-collapse" :class="list.open ? 'uni-active' : ''">
                ...
                <!-- 未编辑过 -->
                <view class="never-edit" v-else @click="toEdit(list)">
...
export default {
  ...
  methods: {
    ...
    toEdit(type) {
      ...
      if (type.id === "specialty") {
        uni.navigateTo({
          url: "/pages/component/specialty/specialty"
        });
      }
      if (type.id === "selfEvaluation") {
        uni.navigateTo({
