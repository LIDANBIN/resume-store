<template>
  <view class="work-experience-wrap">
    ...
    <view class="list">
      ...
      <view class="value">
        <input class="uni-input" focus placeholder="输入项目名称">
        <view class="uni-icon uni-icon-compose"></view>
      </view>
    </view>
    <view class="list">
      <view class="title">项目岗位</view>
      <view class="value">
        <input class="uni-input" focus placeholder="输入项目岗位">
        <view class="uni-icon uni-icon-compose"></view>
      </view>
    </view>
    <view class="list-last">
      <view class="title">项目描述</view>
      <textarea class="content" placeholder="请填写项目描述"/>
    </view>
