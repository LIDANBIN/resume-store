      ...
      <block v-for="(list,index) in lists" :key="index">
        <view class="uni-list-cell uni-collapse">
          <view
            ...
            @click="trigerCollapse(list)"
          >{{list.title}}</view>
          <view class="uni-collapse-content" :class="list.show ? 'uni-active' : ''">
            <view v-if="list.type === 'loadRecord'"></view>
            <view v-if="list.type === 'sendRecord'"></view>
            <view v-if="list.type === 'recharge'"></view>
            <view v-if="list.type === 'upgrade'"></view>
            <view v-if="list.type === 'update'"></view>
          </view>
        </view>
      </block>
    </view>
